...
`{include} data/text/train_df_info.txt`

From @fig-training-info, we see that the training data contains `{python} len(train_df)` observations. Each observation represents a news article with a title, text, subject, date and target label. Notably, we also see that there are no missing values in our training data set which means we can proceed without any imputation or row removal. 
...
![Count of true vs. fake news articles in training dataset](img/fake_real_count.png){#fig-fake-real-count width=40%}
...
![Word cloud for titles of fake news articles](img/fake_title_word_cloud.png){#fig-fake-wordcloud width=40%}

![Word cloud for titles of true news articles](img/true_title_word_cloud.png){#fig-true-wordcloud width=40%}
...
![Word cloud for text of fake news articles](img/fake_text_word_cloud.png){#fig-fake-text-wordcloud width=40%}

![Word cloud for text of true news articles](img/true_text_word_cloud.png){#fig-true-text-wordcloud width=40%}
...
![Distribution of article title lengths for fake and true news articles](img/title_length_dist.png){#fig-length-distributions width=40%}

![Distribution of article text lengths for fake and true news articles](img/text_length_dist.png){#fig-text-length-distributions width=40%}
...
![Percentage of counts of news subjects in fake vs. true news articles](img/subject_percentage_count.png){#fig-subject-counts width=40%}

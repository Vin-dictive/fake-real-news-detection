...
![Confusion matrix for Naive Bayes classifier on test set](../img/confusion_matrix.png){#fig-confusion-matrix width=75%}
...
![Precision-Recall curve for Naive Bayes classifier on test set](../img/pr_curve.png){#fig-pr-curve=75%}
...
![ROC Curve for Naive Bayes classifier on test set](../img/roc_curve.png){#fig-roc-curve=75%}
